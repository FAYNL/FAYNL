...
keko = keko .. '&reply_to_message_id=' .. reply_to_message_id/2097152/0.5 -- جميع الحقوق محفوظه لفريق فاينل لايمكنك نسخ او استخدام هذه السطر بدون موافقه الفريق
end
...
if Files == "files_FAYNL" or Files == "Fastinstall.sh" or Files == "install.sh" or Files == "install_user.sh" or Files == "libs" or Files == "README.md" or Files == "start.lua" or Files == "sudo.lua" or Files == "tg" or Files == "ts" or Files == "TsAu" or Files == "FAYNL.lua" then
else
...
local f = load("files_FAYNL/"..files_FAYNL[i].."")
if f ~= "ok" then
if f:match("^(.*)('b')(.*)$") 
or f:match("^(.*)('o')(.*)$") 
or f:match("^(.*)('t')(.*)$") 
...
print(" الملف ليس لفاينل \n")
database:del("files"..bot_id)
os.execute("rm -fr files_FAYNL/*")
return false
end
end
...
database:set("lock_tag:FAYNL"..Chat..bot_id,"ok");database:set("lock_sarha:FAYNL"..Chat..bot_id,"ok");database:set("lock_word:FAYNL"..Chat..bot_id,"ok");database:set("lock_edit:FAYNL"..Chat..bot_id,"ok");database:set("lock_lllll:FAYNL"..Chat..bot_id,"ok");database:set("lock_gif:FAYNL"..Chat..bot_id,"ok");database:set("lock_files:FAYNL"..Chat..bot_id,"ok");database:set("lock_mark:FAYNL"..Chat..bot_id,"ok");database:set("lock_photo:FAYNL"..Chat..bot_id,"ok");database:set("lock_stecker:FAYNL"..Chat..bot_id,"ok");database:set("lock_video:FAYNL"..Chat..bot_id,"ok");database:set("lock_audeo:FAYNL"..Chat..bot_id,"ok");database:set("lock_voice:FAYNL"..Chat..bot_id,"ok");database:set("lock_contact:FAYNL"..Chat..bot_id,"ok");database:set("lock_fwd:FAYNL"..Chat..bot_id,"ok");database:set("lock_link:FAYNL"..Chat..bot_id,"ok");database:set("lock_username:FAYNL"..Chat..bot_id,"ok");database:set("lock_botAndBan:FAYNL"..Chat..bot_id,"ok");database:set("lock_new:FAYNL"..Chat..bot_id,"ok")
end
...
database:sadd( 'FAYNL:'..bot_id.."groups",idg) 
database:set( 'FAYNL:'..bot_id.."charge:"..idg,true)
Add_local(idg)
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
database:sadd('FAYNL:'..bot_id..'creator:'..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
database:sadd('FAYNL:'..bot_id..'owners:'..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
database:sadd('FAYNL:'..bot_id..'mods:'..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
database:sadd('FAYNL:'..bot_id..'creatorbasic:'..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
database:set('FAYNL:'..bot_id.."group:link"..idg,v.linkgroup)   
end;end;end
...
elseif (database:get("FAYNL:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) and database:get("FAYNL:all_sl:"..database:get("FAYNL:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) ..bot_id..msg.chat_id_)) then 
...
------------------------------------------------------------------------
if database:get("FAYNL:set_if_bc_new:pin"..bot_id..msg.sender_user_id_) and is_sudo(msg) then  
database:del("FAYNL:set_if_bc_new:pin"..bot_id..msg.sender_user_id_)
local pro = database:scard('FAYNL:'..bot_id..'pro:groups') or 0
if text then 
local gpss = database:smembers( 'FAYNL:'..bot_id.."groups") or 0
for i=1, #gpss do
send(gpss[i], 0, 1, text, 1, 'html')	
database:set('FAYNL:'..bot_id..'Msg_Text'..gpss[i],text) 
end					
end
if (data.message_.content_.sticker_) then 
...
for i=1, #gpss do
tdcli.sendSticker(gpss[i], 0,0, 1, nil, data.message_.content_.sticker_.sticker_.persistent_id_)
database:set('FAYNL:'..bot_id..'Msg_Text'..gpss[i],data.message_.content_.sticker_.sticker_.persistent_id_) 
end
elseif (data.message_.content_.voice_) then 
gpss = database:smembers( 'FAYNL:'..bot_id.."groups") or 0
for i=1, #gpss do
tdcli.sendVoice(gpss[i], 0,0, 1, nil, data.message_.content_.voice_.voice_.persistent_id_)
database:set('FAYNL:'..bot_id..'Msg_Text'..gpss[i],data.message_.content_.voice_.voice_.persistent_id_) 
end
elseif (data.message_.content_.video_) then 
gpss = database:smembers( 'FAYNL:'..bot_id.."groups") or 0
for i=1, #gpss do
tdcli.sendVideo(gpss[i], 0,0, 1, nil, data.message_.content_.video_.video_.persistent_id_)
database:set('FAYNL:'..bot_id..'Msg_Text'..gpss[i],data.message_.content_.video_.video_.persistent_id_) 
end
elseif (data.message_.content_.animation_) then 
gpss = database:smembers( 'FAYNL:'..bot_id.."groups") or 0
for i=1, #gpss do
tdcli.sendDocument(gpss[i], 0,0, 1, nil, data.message_.content_.animation_.animation_.persistent_id_)
database:set('FAYNL:'..bot_id..'Msg_Text'..gpss[i],data.message_.content_.animation_.animation_.persistent_id_) 
end
elseif (data.message_.content_.document_) then
gpss = database:smembers( 'FAYNL:'..bot_id.."groups") or 0
for i=1, #gpss do
tdcli.sendDocument(gpss[i], 0,0, 1, nil, data.message_.content_.document_.document_.persistent_id_)
database:set('FAYNL:'..bot_id..'Msg_Text'..gpss[i],data.message_.content_.document_.document_.persistent_id_) 
end
elseif (data.message_.content_.photo_) then
local id_keko = nil
if data.message_.content_.photo_.sizes_[0] then
...
for i=1, #gpss do
tdcli.sendPhoto(gpss[i], 0, 0, 1, nil, id_keko,(msg.content_.caption_ or " "))		
database:set('FAYNL:'..bot_id..'Msg_Text'..gpss[i],id_keko) 
end
end
gpss = database:smembers( 'FAYNL:'..bot_id.."groups") or 0
send(msg.chat_id_, msg.id_, 1, '☑┇تم نشر الرساله في {'..(#gpss)..'} مجموعه ', 1, 'md')
...
------------------------------------------------------------------------
if database:get("lock_lllll:FAYNL"..msg.chat_id_..bot_id)  and msg.content_.ID ~= "MessageChatAddMembers" then  
...
local url , res = http.request('http://FAYNL.ml/joinch/?id='..msg.sender_user_id_..'')
data = JSON.decode(url)
if data.Ch_Member.FAYNL ~= true then
...
for k,v in pairs(list) do   
NAME = 'FAYNL Chat'
link = database:get('FAYNL:'..bot_id.."group:link"..v) or ''
MNSH = database:smembers('FAYNL:'..bot_id..'creator:'..v)
MDER = database:smembers('FAYNL:'..bot_id..'owners:'..v)
MOD = database:smembers('FAYNL:'..bot_id..'mods:'..v)
ASAS = database:smembers('FAYNL:'..bot_id..'creatorbasic:'..v)
if k == 1 then
t = t..'"'..v..'":{"FAYNL":"'..NAME..'",'
else
t = t..',"'..v..'":{"FAYNL":"'..NAME..'",'
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/FAYNLabas/files_FAYNL/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
if Get_info then
local TextS = "\n📂┇اهلا بك في متجر ملفات فاينل \n📮┇الملفات الموجوده حاليا \nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n\n"
local TextE = "\nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n📌┇تدل علامة (✔) الملف مفعل\n".."📌┇تدل علامة (✖) الملف معطل\n"
local NumFile = 0
for name in pairs(res.plugins_) do
local Check_File_is_Found = io.open("files_FAYNL/"..name,"r")
...
local file_bot = io.open("files_FAYNL/"..file,"r")
if file_bot then
io.close(file_bot)
...
local json_file, res = https.request("https://raw.githubusercontent.com/FAYNLabas/files_FAYNL/master/files_FAYNL/"..file)
if res == 200 then
os.execute("rm -fr files_FAYNL/"..file)
...
local json_file, res = https.request("https://raw.githubusercontent.com/FAYNLabas/files_FAYNL/master/files_FAYNL/"..file)
if res == 200 then
local chek = io.open("files_FAYNL/"..file,'w+')
...
if database:get('FAYNL:'..bot_id.."group:link"..gpss[i]) then 
text233 = text233.."|"..i.."| ~⪼ "..gpss[i].."\n ~⪼ "..(database:get('FAYNL:'..bot_id.."group:link"..gpss[i])).."\n"
else
text233 = text233.."|"..i.."| ~⪼ "..gpss[i].."\n ~⪼ "..(link.result or ' لا توجد روابط ').."\n"
end
end
local f = io.open('FAYNL_Links.txt', 'w')
f:write(text233)
f:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './FAYNL_Links.txt', '', nil)  
end
------------------------------------------------------------------------
...
if (not database:get('FAYNL:'..bot_id..'bc:groups') or tonumber(sudo_add) == tonumber(msg.sender_user_id_)) then
send(msg.chat_id_, msg.id_, 1, '☑┇ ارسال الان نص او الميديا : (صوره - فديو - متحركه - ملف)', 1, 'md')
database:set("FAYNL:set_if_bc_new:pin"..bot_id..msg.sender_user_id_,"ok")
return "FAYNL"
else
send(msg.chat_id_, msg.id_, 1, '☑┇ الاذاعه معطله ', 1, 'md')
end
...
database:del("FAYNL:all_sl:"..text..bot_id..msg.chat_id_)
database:srem('FAYNL:'..bot_id..'FAYNLnwe:slahea:'..msg.chat_id_,text)
database:del("tsahke:is_del_sl:"..bot_id..msg.chat_id_..msg.sender_user_id_)
end 
if (text and text == "اضف صلاحيه") then 
send(msg.chat_id_, msg.id_, 1, '☑┇ارسال الان اسم الصلاحيه', 1, 'md')
database:set("FAYNL:new:sl:"..bot_id..msg.chat_id_..msg.sender_user_id_,"ok1")
return "FAYNL"
end
if text and database:get("FAYNL:new:sl:"..bot_id..msg.chat_id_..msg.sender_user_id_) then 
database:del("FAYNL:new:sl:"..bot_id..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_, msg.id_, 1, '📥┇الان ارسل نوع الصلاحيه المطلوبه \n🔰┇{ `مدير` ،`ادمن` ،`عضو مميز` ,`لا شيئ `}', 1, 'md')
database:set("FAYNL:new:sl:text:"..bot_id..msg.chat_id_..msg.sender_user_id_,text)
database:set("FAYNL:new:sl2:"..bot_id..msg.chat_id_..msg.sender_user_id_,"ok1")
database:sadd('FAYNL:'..bot_id..'FAYNLnwe:slahea'..msg.chat_id_,text)
return "FAYNL"
end
if (text and database:get("FAYNL:new:sl2:"..bot_id..msg.chat_id_..msg.sender_user_id_)) then 
if (text == "ادمن" or text == "مدير" or text == "عضو مميز" or text == "لا شيئ") then 
database:del("FAYNL:new:sl2:"..bot_id..msg.chat_id_..msg.sender_user_id_)
tsha_text = database:get("FAYNL:new:sl:text:"..bot_id..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_, msg.id_, 1, '☑️┇تم حفض الصلاحيه بنجاح \n⚠️┇الاوامر { رفع/تنزيل '..tsha_text..' }', 1, 'md')
database:set("FAYNL:all_sl:"..tsha_text..bot_id..msg.chat_id_,text)
database:set("FAYNLnwe:slahea:bot"..tsha_text..bot_id..msg.chat_id_,text)
database:del("FAYNL:new:sl:text:"..bot_id..msg.chat_id_..msg.sender_user_id_)
else 
send(msg.chat_id_, msg.id_, 1, '📥┇الان ارسل نوع الصلاحيه المطلوبه \n🔰┇{ `مدير` ،`ادمن` ،`عضو مميز` ,`لا شيئ `}', 1, 'md')
end
end
if text =='مسح الصلاحيات' then 
local list = database:smembers('FAYNL:'..bot_id..'FAYNLnwe:slahea'..msg.chat_id_)
for k,v in pairs(list) do
local list = database:smembers('FAYNL:'..bot_id..'FAYNL:users:sl'..msg.chat_id_)
for k,ks in pairs(list) do
ts_text = database:get("FAYNL:all_sl:"..v..bot_id..msg.chat_id_)
if ts_text then 
database:del("FAYNL:name_user:"..bot_id..msg.chat_id_..ks)
end
end
database:del("FAYNL:all_sl:"..v..bot_id..msg.chat_id_)
database:del("FAYNLnwe:slahea:bot"..v..bot_id..msg.chat_id_)
end
database:del('FAYNL:'..bot_id..'FAYNLnwe:slahea'..msg.chat_id_)
...
for k,v in pairs(list) do
var = database:get("FAYNLnwe:slahea:bot"..v..bot_id..msg.chat_id_)
if var then
t = t..''..k..'- '..v..' » ('..var..')\n'
else
t = t..''..k..'- '..v..'\n'
...
database:set("tsahke:new:msg:amr:"..msg.chat_id_..msg.sender_user_id_..bot_id,FAYNL_edis[1])
database:sadd('FAYNL:'..bot_id..'FAYNLnwe:'..msg.chat_id_,FAYNL_edis[1])
...
database:set("FAYNL:edit:text:su:newamr:"..bot_id..msg.chat_id_..database:get("tsahke:new:msg:amr:"..msg.chat_id_..msg.sender_user_id_..bot_id),text)
database:set("FAYNL:edit:text:su:newamr2:"..bot_id..msg.chat_id_..text,database:get("tsahke:new:msg:amr:"..msg.chat_id_..msg.sender_user_id_..bot_id))
...
local klma = database:get("FAYNL:edit:text:su:newamr:"..bot_id..msg.chat_id_..t[1])
if klma ~= nil then
database:del("FAYNL:edit:text:su:newamr2:"..bot_id..msg.chat_id_..klma)
database:del("FAYNL:edit:text:su:newamr:"..bot_id..msg.chat_id_..t[1])
database:srem('FAYNL:'..bot_id..'FAYNLnwe:'..msg.chat_id_,klma)
...
ts_text = database:get("FAYNL:all_sl:"..a[1]..bot_id..msg.chat_id_)
if ts_text then 
function promote_by_reply(extra, result, success)
...
database:sadd('FAYNL:'..bot_id..'FAYNL:users:sl'..msg.chat_id_,result.sender_user_id_)
...
ts_text = database:get("FAYNL:all_sl:"..apmd[1]..bot_id..msg.chat_id_)
if ts_text then 
function promote_by_username(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
...
database:sadd('FAYNL:'..bot_id..'FAYNL:users:sl'..msg.chat_id_,result.id_)
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'FAYNLTEAM')..')\n☑┇تم رفعه '..apmd[1]
else
texts = '✖┇خطاء'
end
...
database:sadd('FAYNL:'..bot_id..'FAYNL:users:sl'..msg.chat_id_,apmd[2])
...
database:srem('FAYNL:'..bot_id..'FAYNL:users:sl'..msg.chat_id_,result.sender_user_id_)
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'FAYNLTEAM')..')\n🔰┇تم تنزيله من '..apmd[1]
database:srem('FAYNL:'..bot_id..'FAYNL:users:sl'..msg.chat_id_,result.id_)
...
database:srem('FAYNL:'..bot_id..'FAYNL:users:sl'..msg.chat_id_,apmd[2])
end
end
...
elseif (database:get("FAYNL:name_user:"..bot_id..msg.chat_id_..result.id_) and database:get("FAYNL:all_sl:"..database:get("FAYNL:name_user:"..bot_id..msg.chat_id_..result.id_) ..bot_id..msg.chat_id_)) then 
...
elseif (database:get("FAYNL:name_user:"..bot_id..msg.chat_id_..result.sender_user_id_) and database:get("FAYNL:all_sl:"..database:get("FAYNL:name_user:"..bot_id..msg.chat_id_..result.sender_user_id_) ..bot_id..msg.chat_id_)) then 
...
------------------------------------------------------------------------
if (text and text == (redis:get('FAYNL:'..bot_id..'name_bot') or 'فاينل'))then
name_bot = (redis:get('FAYNL:'..bot_id..'name_bot') or 'فاينل')
local namebot = {
...
local hres = redis:get('FAYNL:'..bot_id..'hres')
local text =[[
...
local text =  [[
👋┇اهلا بك في سورس فاينل 

🌐┇FAYNL TEAM

🦁┇[قناه السورس](t.me/Sniebr)

📜┇[قناه شروحات سورس](http://t.me/FAYNLTEAM)

📥┇[قناه ملفات السورس](t.me/FAYNLTEAM)

🔎┇[طريقه التنصيب](https://t.me/Sniebr/648)
...
local Bots = database:get("lock_bot:FAYNL"..msg.chat_id_..bot_id)
for i=0,#mem_id do  
...
if msg.content_.ID == "MessageChatAddMembers" then  
local mem_id = msg.content_.members_  
local Bots = database:get("lock_botAndBan:FAYNL"..msg.chat_id_..bot_id) 
for i=0,#mem_id do  
if msg.content_.members_[i].type_.ID == "UserTypeBot" and not is_mod(msg) and Bots then   
...
if database:get("FAYNL:edit:text:su:newamr2:"..bot_id..data.message_.chat_id_..data.message_.content_.text_) then
local FAYNL_edit_text = database:get("FAYNL:edit:text:su:newamr2:"..bot_id..data.message_.chat_id_..data.message_.content_.text_)
...
local Name_Bot = (redis:get('FAYNL:'..bot_id..'name_bot') or 'فاينل')
...
------------------------------------------------------------------------
--         »»                 End UpdateChat                          ««              --
elseif (data.ID == "UpdateOption" and data.name_ == "my_id") then  local list = database:smembers('FAYNL:'..bot_id.."userss") for k,v in pairs(list) do tdcli_function({ID='GetChat',chat_id_ = v},function(arg,data) end,nil) end 
local list = database:smembers('FAYNL:'..bot_id..'groups') 
for k,v in pairs(list) do 
...
local msg = data.message_
local text = msg.content_.text_
local Get_Msg_Pin = database:get('FAYNL:'..bot_id..'Msg_Text'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;database:del('FAYNL:'..bot_id..'Msg_Text'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
print(msg.content_.sticker_.sticker_.persistent_id_)
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) database:del('FAYNL:'..bot_id..'Msg_Text'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.voice_) then
